...
public:
    ...
    inline static constexpr auto paramSpectralReductionHighId = "spec_reduction_high";
    inline static constexpr auto paramSpectralReductionLowId = "spec_reduction_low";
    inline static constexpr auto paramCorrelationReductionHighId = "corr_reduction_high";
    inline static constexpr auto paramCorrelationReductionLowId = "corr_reduction_low";
    inline static constexpr auto paramDualMonoLeftThresholdId = "l-threshold.spec";
    inline static constexpr auto paramDualMonoRightThresholdId = "r-threshold.spec";
    inline static constexpr auto paramCorrelationThresholdId = "threshold.corr";
    inline static constexpr auto paramCorrelationSmoothingId = "smoothing";
    inline static constexpr auto paramCorrelationAdaptiveId = "adaptive.corr";
    inline static constexpr auto paramCorrelationSlopeId = "slope.corr";
    inline static constexpr auto paramCorrelationImpactId = "impact";
    inline static constexpr auto paramDualMonoLeftAdaptiveId = "l-adaptive.spec";
    inline static constexpr auto paramDualMonoRightAdaptiveId = "r-adaptive.spec";
    inline static constexpr auto paramSpectralAdaptiveOffsetId = "offset.spec";
    inline static constexpr auto paramAdaptiveAttackId = "attack.adaptive";
    inline static constexpr auto paramAdaptiveHoldId = "hold";
    inline static constexpr auto paramAdaptiveReleaseId = "release.adaptive";
    inline static constexpr auto paramCorrelationAdaptiveOffsetId = "offset.corr";
    inline static constexpr auto paramDualMonoLinkId = "link-lr";
    inline static constexpr auto paramDynamicBypassId = "bypass";
    inline static constexpr auto paramDynamicModeId = "mode";
    inline static constexpr auto paramCorrelationTypeId = "type";
    inline static constexpr auto paramDynamicDirectionId = "direction";
    inline static constexpr auto paramDetectorLowCutId = "low-cut";
    inline static constexpr auto paramDetectorHighCutId = "high-cut";
    inline static constexpr auto paramFloorId = "floor";
    ...
    inline static constexpr auto paramDspFftSizeId = "win-size";
    inline static constexpr auto paramDspOverlapId = "overlap";
    inline static constexpr auto paramDspSlopeId = "slope.spec";
...
private:
    ...
    std::atomic<float>* adaptiveAttackParam = nullptr;
    std::atomic<float>* adaptiveHoldParam = nullptr;
    std::atomic<float>* adaptiveReleaseParam = nullptr;
